...
class UserBean{
  ...
  String errorMsg;
  UserData data;
  UserBean.fromParams({this.errorCode, this.errorMsg, this.data});

  factory UserBean(jsonStr) => jsonStr == null ? null : jsonStr is String ? new UserBean.fromJson(json.decode(jsonStr)) : new UserBean.fromJson(jsonStr);
